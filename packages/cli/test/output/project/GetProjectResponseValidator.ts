...
import {
  ...
  type IGetProjectSuccessResponse,
...
export class GetProjectResponseValidator extends ResponseValidator {
  public safeValidate(
    response: IHttpResponse,
  ): SafeResponseValidationResult<GetProjectResponse> {
    ...
    let data: GetProjectResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "GetProjectSuccess") {
          data = new GetProjectSuccessResponse(
            validationResult.validatedResponse as unknown as IGetProjectSuccessResponse,
          );
          break;
        }
  ...
  public validate(response: IHttpResponse): GetProjectResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isGetProjectSuccessResponse =
        this.validateGetProjectSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isGetProjectSuccessResponse) {
        return { validResponseName: "GetProjectSuccess", validatedResponse };
      }
    }
  ...
  private validateGetProjectSuccessResponse(
    response: IHttpResponse,
    ...
    assert(
      ...
      "'GetProjectSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'GetProjectSuccessResponseHeader' has to be defined in the definition",
    );
