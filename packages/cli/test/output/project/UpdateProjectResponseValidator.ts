...
export class UpdateProjectResponseValidator extends ResponseValidator {
  public safeValidate(
    response: IHttpResponse,
  ): SafeResponseValidationResult<UpdateProjectResponse> {
    ...
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "UpdateProjectSuccess") {
          data = new UpdateProjectSuccessResponse(
            validationResult.validatedResponse as unknown as IUpdateProjectSuccessResponse,
          );
          break;
        }
      ...
      case 409: {
        if (
          ...
          "NotUpdateableProjectStatusError"
        ) {
          data = new NotUpdateableProjectStatusErrorResponse(
            validationResult.validatedResponse as unknown as INotUpdateableProjectStatusErrorResponse,
          );
          break;
        }
      ...
      case 422: {
        if (validationResult.validResponseName === "NonExistingFunnelError") {
          data = new NonExistingFunnelErrorResponse(
            validationResult.validatedResponse as unknown as INonExistingFunnelErrorResponse,
          );
          break;
        }

        if (validationResult.validResponseName === "NonExistingAdError") {
          data = new NonExistingAdErrorResponse(
            validationResult.validatedResponse as unknown as INonExistingAdErrorResponse,
          );
          break;
        }
  ...
  public validate(response: IHttpResponse): UpdateProjectResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isUpdateProjectSuccessResponse =
        this.validateUpdateProjectSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isUpdateProjectSuccessResponse) {
        return { validResponseName: "UpdateProjectSuccess", validatedResponse };
      }
    }
    ...
    if (response.statusCode === 409) {
      const isNotUpdateableProjectStatusErrorResponse =
        this.validateNotUpdateableProjectStatusErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isNotUpdateableProjectStatusErrorResponse) {
        return {
          validResponseName: "NotUpdateableProjectStatusError",
          validatedResponse,
        };
      }
    }
    ...
    if (response.statusCode === 422) {
      const isNonExistingFunnelErrorResponse =
        this.validateNonExistingFunnelErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isNonExistingFunnelErrorResponse) {
        return {
          validResponseName: "NonExistingFunnelError",
          validatedResponse,
        };
      }

      const isNonExistingAdErrorResponse =
        this.validateNonExistingAdErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isNonExistingAdErrorResponse) {
        return { validResponseName: "NonExistingAdError", validatedResponse };
      }
    }
  ...
  private validateUpdateProjectSuccessResponse(
    response: IHttpResponse,
    ...
    assert(
      ...
      "'UpdateProjectSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'UpdateProjectSuccessResponseHeader' has to be defined in the definition",
    );
  ...
  private validateNotUpdateableProjectStatusErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'NotUpdateableProjectStatusErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'NotUpdateableProjectStatusErrorResponseHeader' has to be defined in the definition",
    );
  ...
  private validateNonExistingFunnelErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'NonExistingFunnelErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'NonExistingFunnelErrorResponseHeader' has to be defined in the definition",
    );
  ...
  private validateNonExistingAdErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'NonExistingAdErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'NonExistingAdErrorResponseHeader' has to be defined in the definition",
    );
