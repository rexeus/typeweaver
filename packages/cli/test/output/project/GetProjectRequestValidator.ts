...
export class GetProjectRequestValidator extends RequestValidator {
  public safeValidate(
    request: IHttpRequest,
  ): SafeRequestValidationResult<IGetProjectRequest> {
    ...
    return {
      isValid: true,
      data: validatedRequest as IGetProjectRequest,
    };
  }

  public validate(request: IHttpRequest): IGetProjectRequest {
