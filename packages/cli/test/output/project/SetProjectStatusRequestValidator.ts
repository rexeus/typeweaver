...
export class SetProjectStatusRequestValidator extends RequestValidator {
  public safeValidate(
  ...
  ): SafeRequestValidationResult<ISetProjectStatusRequest> {
    ...
    return {
      isValid: true,
      data: validatedRequest as ISetProjectStatusRequest,
    };
  }

  public validate(request: IHttpRequest): ISetProjectStatusRequest {
