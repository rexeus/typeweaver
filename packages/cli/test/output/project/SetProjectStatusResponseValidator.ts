...
export class SetProjectStatusResponseValidator extends ResponseValidator {
  public safeValidate(
    response: IHttpResponse,
  ): SafeResponseValidationResult<SetProjectStatusResponse> {
    ...
    let data: SetProjectStatusResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "SetProjectStatusSuccess") {
          data = new SetProjectStatusSuccessResponse(
            validationResult.validatedResponse as unknown as ISetProjectStatusSuccessResponse,
          );
          break;
        }
      ...
      case 404: {
        if (validationResult.validResponseName === "ProjectNotFoundError") {
          data = new ProjectNotFoundErrorResponse(
            validationResult.validatedResponse as unknown as IProjectNotFoundErrorResponse,
          );
          break;
        }
      ...
      case 409: {
        if (
          validationResult.validResponseName === "ProjectStatusTransitionError"
        ) {
          data = new ProjectStatusTransitionErrorResponse(
            validationResult.validatedResponse as unknown as IProjectStatusTransitionErrorResponse,
          );
          break;
        }

        if (validationResult.validResponseName === "ProjectPublishError") {
          data = new ProjectPublishErrorResponse(
            validationResult.validatedResponse as unknown as IProjectPublishErrorResponse,
          );
          break;
        }

        if (
          validationResult.validResponseName === "ProjectRequestGenerationError"
        ) {
          data = new ProjectRequestGenerationErrorResponse(
            validationResult.validatedResponse as unknown as IProjectRequestGenerationErrorResponse,
          );
          break;
        }
  ...
  public validate(response: IHttpResponse): SetProjectStatusResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isSetProjectStatusSuccessResponse =
        this.validateSetProjectStatusSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isSetProjectStatusSuccessResponse) {
        return {
          validResponseName: "SetProjectStatusSuccess",
          validatedResponse,
        };
      }
    }
    ...
    if (response.statusCode === 404) {
      const isProjectNotFoundErrorResponse =
        this.validateProjectNotFoundErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isProjectNotFoundErrorResponse) {
        return { validResponseName: "ProjectNotFoundError", validatedResponse };
      }
    }

    if (response.statusCode === 409) {
      const isProjectStatusTransitionErrorResponse =
        this.validateProjectStatusTransitionErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isProjectStatusTransitionErrorResponse) {
        return {
          validResponseName: "ProjectStatusTransitionError",
          validatedResponse,
        };
      }

      const isProjectPublishErrorResponse =
        this.validateProjectPublishErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isProjectPublishErrorResponse) {
        return { validResponseName: "ProjectPublishError", validatedResponse };
      }

      const isProjectRequestGenerationErrorResponse =
        this.validateProjectRequestGenerationErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isProjectRequestGenerationErrorResponse) {
        return {
          validResponseName: "ProjectRequestGenerationError",
          validatedResponse,
        };
      }
    }
  ...
  private validateSetProjectStatusSuccessResponse(
    response: IHttpResponse,
    ...
    assert(
      ...
      "'SetProjectStatusSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'SetProjectStatusSuccessResponseHeader' has to be defined in the definition",
    );
  ...
  private validateProjectNotFoundErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'ProjectNotFoundErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'ProjectNotFoundErrorResponseHeader' has to be defined in the definition",
    );
  ...
  private validateProjectStatusTransitionErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'ProjectStatusTransitionErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'ProjectStatusTransitionErrorResponseHeader' has to be defined in the definition",
    );
  ...
  private validateProjectPublishErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'ProjectPublishErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'ProjectPublishErrorResponseHeader' has to be defined in the definition",
    );
  ...
  private validateProjectRequestGenerationErrorResponse(
    response: IHttpResponse,
    validatedResponse: IHttpResponse,
    error: ResponseValidationError,
  ): boolean {
    ...
    assert(
      ...
      "'ProjectRequestGenerationErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'ProjectRequestGenerationErrorResponseHeader' has to be defined in the definition",
    );
