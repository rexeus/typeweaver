...
export class GetPublicFunnelRequestValidator extends RequestValidator {
  public safeValidate(
  ...
  ): SafeRequestValidationResult<IGetPublicFunnelRequest> {
    ...
    return {
      isValid: true,
      data: validatedRequest as IGetPublicFunnelRequest,
    };
  }

  public validate(request: IHttpRequest): IGetPublicFunnelRequest {
