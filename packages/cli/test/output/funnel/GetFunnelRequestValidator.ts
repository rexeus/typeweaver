...
export class GetFunnelRequestValidator extends RequestValidator {
  public safeValidate(
    request: IHttpRequest,
  ): SafeRequestValidationResult<IGetFunnelRequest> {
    ...
    return {
      isValid: true,
      data: validatedRequest as IGetFunnelRequest,
    };
  }

  public validate(request: IHttpRequest): IGetFunnelRequest {
