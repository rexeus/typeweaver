...
import {
  ...
  type IListTodosSuccessResponse,
...
export class ListTodosResponseValidator extends ResponseValidator {
  public safeValidate(
    response: IHttpResponse,
  ): SafeResponseValidationResult<ListTodosResponse> {
    ...
    let data: ListTodosResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "ListTodosSuccess") {
          data = new ListTodosSuccessResponse(
            validationResult.validatedResponse as unknown as IListTodosSuccessResponse,
          );
          break;
        }
  ...
  public validate(response: IHttpResponse): ListTodosResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isListTodosSuccessResponse = this.validateListTodosSuccessResponse(
        response,
        validatedResponse,
        error,
      );
      if (isListTodosSuccessResponse) {
        return { validResponseName: "ListTodosSuccess", validatedResponse };
      }
    }
  ...
  private validateListTodosSuccessResponse(
    response: IHttpResponse,
    ...
    assert(
      ...
      "'ListTodosSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'ListTodosSuccessResponseHeader' has to be defined in the definition",
    );
