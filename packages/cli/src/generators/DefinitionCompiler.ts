...
export class DefinitionCompiler {
  private static readonly GENERATED_HEADER = [
    "/* eslint-disable */",
    "/**",
  ...
  private generateDtsStub(source: string): string {
    if (source.startsWith(DefinitionCompiler.GENERATED_HEADER)) {
      return source;
    }

    const lines: string[] = [DefinitionCompiler.GENERATED_HEADER];
    let hasDefaultExport = false;
    let pastLeadingComments = false;
    let exportBlock: string | null = null;
