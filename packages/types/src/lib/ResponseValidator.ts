  ...
  implements IResponseValidator
{
  ...
  protected validateResponseType<Response extends IHttpResponse>(
    ...
    error: ResponseValidationError) => SafeResponseValidationResult<Response> {
      return (response, error) => {
        ...
        if (bodySchema) {
          const validateBodyResult = bodySchema.safeParse(response.body) as unknown as ZodSafeParseResult<Response["body"]>;
        ...
        if (headerSchema) {
          ...
          const validateHeaderResult = headerSchema.safeParse(coercedHeader) as unknown as ZodSafeParseResult<Response["header"]>;
