...
export class RegisterAccountResponseValidator extends ResponseValidator {
  ...
  private validateRegisterAccountSuccessResponse(
  ...
  ): SafeResponseValidationResult<IRegisterAccountSuccessResponse> {
    const result = this.validateResponseType<IRegisterAccountSuccessResponse>(
    ...
    return {
      isValid: true,
      data: {
        _tag: "RegisterAccountSuccess" as const,
        statusCode: result.data.statusCode,
        header: result.data.header,
        body: result.data.body,
      } as IRegisterAccountSuccessResponse,
    };
  }
