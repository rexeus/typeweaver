...
export class RefreshTokenResponseValidator extends ResponseValidator {
  public safeValidate(response: IHttpResponse): SafeResponseValidationResult<RefreshTokenResponse> {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateRefreshTokenSuccessResponseResult = this.validateRefreshTokenSuccessResponse(
        response,
        error,
      );
  ...
  private validateRefreshTokenSuccessResponse(
    ...
    const result = this.validateResponseType<RefreshTokenSuccessResponse>(
      "RefreshTokenSuccess",
    ...
    return {
      isValid: true,
      data: new RefreshTokenSuccessResponse(result.data as IRefreshTokenSuccessResponse),
    };
  }
