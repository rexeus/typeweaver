...
export class RefreshTokenResponseValidator extends ResponseValidator {
  ...
  private validateRefreshTokenSuccessResponse(
  ...
  ): SafeResponseValidationResult<IRefreshTokenSuccessResponse> {
    const result = this.validateResponseType<IRefreshTokenSuccessResponse>(
      "RefreshTokenSuccess",
    ...
    return {
      ...
      } as IRefreshTokenSuccessResponse,
    };
  }
