...
export class RefreshTokenRequestValidator extends RequestValidator<IRefreshTokenRequest> {
  public safeValidate(request: IRawHttpRequest): SafeRequestValidationResult<IRefreshTokenRequest> {
    const error = new RequestValidationError();

    const bodySchema = this.requireRequestSchema(definition.request.body, "body");
    const bodyResult = this.safeParseAs<IRefreshTokenRequestBody>(bodySchema, request.body);
  ...
  public validate(request: IRawHttpRequest): IRefreshTokenRequest {
