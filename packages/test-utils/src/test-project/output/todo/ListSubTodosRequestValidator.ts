...
export class ListSubTodosRequestValidator extends RequestValidator<IListSubTodosRequest> {
  public safeValidate(request: IRawHttpRequest): SafeRequestValidationResult<IListSubTodosRequest> {
    ...
    const headerResult = this.safeParseAs<IListSubTodosRequestHeader>(headerSchema, coercedHeader);
    ...
    const paramResult = this.safeParseAs<IListSubTodosRequestParam>(paramSchema, request.param);
    ...
    const queryResult = this.safeParseAs<IListSubTodosRequestQuery>(querySchema, coercedQuery);
  ...
  public validate(request: IRawHttpRequest): IListSubTodosRequest {
