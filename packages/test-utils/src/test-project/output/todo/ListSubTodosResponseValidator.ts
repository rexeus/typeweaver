...
export class ListSubTodosResponseValidator extends ResponseValidator {
  ...
  private validateListSubTodosSuccessResponse(
  ...
  ): SafeResponseValidationResult<IListSubTodosSuccessResponse> {
    const result = this.validateResponseType<IListSubTodosSuccessResponse>(
      "ListSubTodosSuccess",
    ...
    return {
      ...
      } as IListSubTodosSuccessResponse,
    };
  }
