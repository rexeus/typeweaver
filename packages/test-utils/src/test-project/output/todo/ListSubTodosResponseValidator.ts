...
import {
  ...
  type IListSubTodosSuccessResponse,
  ListSubTodosSuccessResponse,
} from "./ListSubTodosResponse";
...
export class ListSubTodosResponseValidator extends ResponseValidator {
  public safeValidate(
    ...
    let data: ListSubTodosResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "ListSubTodosSuccess") {
          data = new ListSubTodosSuccessResponse(
            validationResult.validatedResponse as unknown as IListSubTodosSuccessResponse,
          );
          break;
        }
  ...
  public validate(response: IHttpResponse): ListSubTodosResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isListSubTodosSuccessResponse =
        this.validateListSubTodosSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isListSubTodosSuccessResponse) {
        return { validResponseName: "ListSubTodosSuccess", validatedResponse };
      }
    }
  ...
  private validateListSubTodosSuccessResponse(
    response: IHttpResponse,
    ...
    assert(
      ...
      "'ListSubTodosSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'ListSubTodosSuccessResponseHeader' has to be defined in the definition",
    );
