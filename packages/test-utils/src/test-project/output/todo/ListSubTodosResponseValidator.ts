...
import {
  ...
  type IListSubTodosSuccessResponseBody,
  type IListSubTodosSuccessResponseHeader,
...
export class ListSubTodosResponseValidator extends ResponseValidator {
  ...
  private validateListSubTodosSuccessResponse(
  ...
  ): SafeResponseValidationResult<ListSubTodosSuccessResponse> {
    let isValid = true;
    ...
    const validateBodyResult = definition.responses[0].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<IListSubTodosSuccessResponseBody>;
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IListSubTodosSuccessResponseHeader>;
    ...
    return {
      ...
      data: new ListSubTodosSuccessResponse(
        validatedResponse as IListSubTodosSuccessResponse,
      ),
    };
  }
