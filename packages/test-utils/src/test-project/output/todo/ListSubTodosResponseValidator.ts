...
const listSubTodosSuccessDefinition = getResponseDefinition(
...
export class ListSubTodosResponseValidator extends ResponseValidator<ListSubTodosResponse> {
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      ...
      statusCode: 200,
      headerSchema: listSubTodosSuccessDefinition.header,
      bodySchema: listSubTodosSuccessDefinition.body,
    },
