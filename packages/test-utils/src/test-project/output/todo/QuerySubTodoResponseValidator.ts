...
export class QuerySubTodoResponseValidator extends ResponseValidator {
  public safeValidate(response: IHttpResponse): SafeResponseValidationResult<QuerySubTodoResponse> {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateQuerySubTodoSuccessResponseResult = this.validateQuerySubTodoSuccessResponse(
        response,
        error,
      );
  ...
  private validateQuerySubTodoSuccessResponse(
    ...
    const result = this.validateResponseType<QuerySubTodoSuccessResponse>(
      "QuerySubTodoSuccess",
    ...
    return {
      isValid: true,
      data: new QuerySubTodoSuccessResponse(result.data as IQuerySubTodoSuccessResponse),
    };
  }
