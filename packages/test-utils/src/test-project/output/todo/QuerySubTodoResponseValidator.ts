...
const querySubTodoSuccessDefinition = getResponseDefinition(
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      ...
      statusCode: 200,
      headerSchema: querySubTodoSuccessDefinition.header,
      bodySchema: querySubTodoSuccessDefinition.body,
    },
