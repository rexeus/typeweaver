...
export class QuerySubTodoResponseValidator extends ResponseValidator {
  ...
  private validateQuerySubTodoSuccessResponse(
  ...
  ): SafeResponseValidationResult<IQuerySubTodoSuccessResponse> {
    const result = this.validateResponseType<IQuerySubTodoSuccessResponse>(
      "QuerySubTodoSuccess",
    ...
    return {
      isValid: true,
      data: {
        type: "QuerySubTodoSuccess" as const,
        statusCode: result.data.statusCode,
        header: result.data.header,
        body: result.data.body,
      } as IQuerySubTodoSuccessResponse,
    };
  }
