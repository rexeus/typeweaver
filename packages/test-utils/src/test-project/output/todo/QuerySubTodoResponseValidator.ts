...
import {
  ...
  type IQuerySubTodoSuccessResponseBody,
  type IQuerySubTodoSuccessResponseHeader,
...
export class QuerySubTodoResponseValidator extends ResponseValidator {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateQuerySubTodoSuccessResponseResult =
        this.validateQuerySubTodoSuccessResponse(response, error);
      if (validateQuerySubTodoSuccessResponseResult.isValid) {
        return validateQuerySubTodoSuccessResponseResult;
      }
    }
  ...
  private validateQuerySubTodoSuccessResponse(
  ...
  ): SafeResponseValidationResult<QuerySubTodoSuccessResponse> {
    let isValid = true;
    ...
    const validateBodyResult = definition.responses[0].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<IQuerySubTodoSuccessResponseBody>;
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IQuerySubTodoSuccessResponseHeader>;
    ...
    return {
      ...
      data: new QuerySubTodoSuccessResponse(
        validatedResponse as IQuerySubTodoSuccessResponse,
      ),
    };
  }
