...
import {
  ...
  type IPutTodoSuccessResponseBody,
  type IPutTodoSuccessResponseHeader,
...
export class PutTodoResponseValidator extends ResponseValidator {
  ...
  private validatePutTodoSuccessResponse(
  ...
  ): SafeResponseValidationResult<PutTodoSuccessResponse> {
    let isValid = true;
    ...
    const validateBodyResult = definition.responses[0].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<IPutTodoSuccessResponseBody>;
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IPutTodoSuccessResponseHeader>;
    ...
    return {
      ...
      data: new PutTodoSuccessResponse(
        validatedResponse as IPutTodoSuccessResponse,
      ),
    };
  }
