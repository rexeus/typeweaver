...
const putTodoSuccessDefinition = getResponseDefinition(definition.responses, "PutTodoSuccess");
...
export class PutTodoResponseValidator extends ResponseValidator<PutTodoResponse> {
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      name: "PutTodoSuccess",
      statusCode: 200,
      headerSchema: putTodoSuccessDefinition.header,
      bodySchema: putTodoSuccessDefinition.body,
    },
