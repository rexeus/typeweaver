...
export class OptionsTodoRequestValidator extends RequestValidator<IOptionsTodoRequest> {
  public safeValidate(request: IRawHttpRequest): SafeRequestValidationResult<IOptionsTodoRequest> {
    ...
    const headerResult = this.safeParseAs<IOptionsTodoRequestHeader>(headerSchema, coercedHeader);
    ...
    const paramResult = this.safeParseAs<IOptionsTodoRequestParam>(paramSchema, request.param);
  ...
  public validate(request: IRawHttpRequest): IOptionsTodoRequest {
