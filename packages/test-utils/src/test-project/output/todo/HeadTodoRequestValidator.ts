...
export class HeadTodoRequestValidator extends RequestValidator {
  public safeValidate(
    request: IHttpRequest,
  ): SafeRequestValidationResult<IHeadTodoRequest> {
    ...
    return {
      isValid: true,
      data: validatedRequest as IHeadTodoRequest,
    };
  }

  public validate(request: IHttpRequest): IHeadTodoRequest {
