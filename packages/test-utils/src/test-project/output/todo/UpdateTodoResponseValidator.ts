...
import {
  ...
  type IUpdateTodoSuccessResponse,
...
export class UpdateTodoResponseValidator extends ResponseValidator {
  public safeValidate(
    ...
    let data: UpdateTodoResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "UpdateTodoSuccess") {
          data = new UpdateTodoSuccessResponse(
            validationResult.validatedResponse as unknown as IUpdateTodoSuccessResponse,
          );
          break;
        }
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isUpdateTodoSuccessResponse =
        this.validateUpdateTodoSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isUpdateTodoSuccessResponse) {
        return { validResponseName: "UpdateTodoSuccess", validatedResponse };
      }
    }
  ...
  private validateUpdateTodoSuccessResponse(
    ...
    assert(
      ...
      "'UpdateTodoSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'UpdateTodoSuccessResponseHeader' has to be defined in the definition",
    );
