...
import {
  ...
  type IUpdateTodoSuccessResponseHeader,
...
import {
  ...
  type ITodoNotChangeableErrorResponseBody,
  type ITodoNotChangeableErrorResponseHeader,
...
export class UpdateTodoResponseValidator extends ResponseValidator {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateUpdateTodoSuccessResponseResult =
        this.validateUpdateTodoSuccessResponse(response, error);
  ...
  private validateUpdateTodoSuccessResponse(
  ...
  ): SafeResponseValidationResult<UpdateTodoSuccessResponse> {
    let isValid = true;
    ...
    const validateBodyResult = definition.responses[0].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<IUpdateTodoSuccessResponseBody>;

    if (!validateBodyResult.success) {
      error.addBodyIssues("UpdateTodoSuccess", validateBodyResult.error.issues);
      isValid = false;
    } else {
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IUpdateTodoSuccessResponseHeader>;
    ...
    return {
      ...
      data: new UpdateTodoSuccessResponse(
        validatedResponse as IUpdateTodoSuccessResponse,
      ),
    };
  }
  ...
  private validateTodoNotChangeableErrorResponse(
    ...
    const validateBodyResult = definition.responses[2].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<ITodoNotChangeableErrorResponseBody>;
    ...
    const validateHeaderResult = definition.responses[2].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<ITodoNotChangeableErrorResponseHeader>;
    ...
    return {
      ...
      data: new TodoNotChangeableErrorResponse(
        validatedResponse as ITodoNotChangeableErrorResponse,
      ),
    };
  }
