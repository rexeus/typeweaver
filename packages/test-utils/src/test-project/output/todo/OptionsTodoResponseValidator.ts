...
export class OptionsTodoResponseValidator extends ResponseValidator<OptionsTodoResponse> {
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      ...
      statusCode: 200,
      headerSchema: responseDefinitions.get("OptionsTodoSuccess")?.header,
      bodySchema: responseDefinitions.get("OptionsTodoSuccess")?.body,
    },
