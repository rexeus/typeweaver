...
import {
  ...
  type IOptionsTodoSuccessResponseHeader,
...
export class OptionsTodoResponseValidator extends ResponseValidator {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateOptionsTodoSuccessResponseResult =
        this.validateOptionsTodoSuccessResponse(response, error);
  ...
  private validateOptionsTodoSuccessResponse(
  ...
  ): SafeResponseValidationResult<OptionsTodoSuccessResponse> {
    let isValid = true;
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IOptionsTodoSuccessResponseHeader>;
    ...
    return {
      ...
      data: new OptionsTodoSuccessResponse(
        validatedResponse as IOptionsTodoSuccessResponse,
      ),
    };
  }
