...
const queryTodoSuccessDefinition = getResponseDefinition(definition.responses, "QueryTodoSuccess");
...
export class QueryTodoResponseValidator extends ResponseValidator<QueryTodoResponse> {
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      ...
      statusCode: 200,
      headerSchema: queryTodoSuccessDefinition.header,
      bodySchema: queryTodoSuccessDefinition.body,
    },
