...
export class ListTodosResponseValidator extends ResponseValidator {
  public safeValidate(response: IHttpResponse): SafeResponseValidationResult<ListTodosResponse> {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateListTodosSuccessResponseResult = this.validateListTodosSuccessResponse(
        response,
        error,
      );
  ...
  private validateListTodosSuccessResponse(
    ...
    const result = this.validateResponseType<ListTodosSuccessResponse>(
      "ListTodosSuccess",
    ...
    return {
      isValid: true,
      data: new ListTodosSuccessResponse(result.data as IListTodosSuccessResponse),
    };
  }
