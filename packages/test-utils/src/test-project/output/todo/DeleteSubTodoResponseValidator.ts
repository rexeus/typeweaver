...
import {
  ...
  type IDeleteSubTodoSuccessResponseBody,
  type IDeleteSubTodoSuccessResponseHeader,
...
export class DeleteSubTodoResponseValidator extends ResponseValidator {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateDeleteSubTodoSuccessResponseResult =
        this.validateDeleteSubTodoSuccessResponse(response, error);
  ...
  private validateDeleteSubTodoSuccessResponse(
    ...
    const validateBodyResult = definition.responses[0].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<IDeleteSubTodoSuccessResponseBody>;
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IDeleteSubTodoSuccessResponseHeader>;
    ...
    return {
      ...
      data: new DeleteSubTodoSuccessResponse(
        validatedResponse as IDeleteSubTodoSuccessResponse,
      ),
    };
  }
