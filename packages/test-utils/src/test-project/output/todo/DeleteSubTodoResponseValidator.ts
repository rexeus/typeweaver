...
export class DeleteSubTodoResponseValidator extends ResponseValidator {
  public safeValidate(
    ...
    let data: DeleteSubTodoResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "DeleteSubTodoSuccess") {
          data = new DeleteSubTodoSuccessResponse(
            validationResult.validatedResponse as unknown as IDeleteSubTodoSuccessResponse,
          );
          break;
        }
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isDeleteSubTodoSuccessResponse =
        this.validateDeleteSubTodoSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isDeleteSubTodoSuccessResponse) {
        return { validResponseName: "DeleteSubTodoSuccess", validatedResponse };
      }
    }
  ...
  private validateDeleteSubTodoSuccessResponse(
    ...
    assert(
      ...
      "'DeleteSubTodoSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'DeleteSubTodoSuccessResponseHeader' has to be defined in the definition",
    );
