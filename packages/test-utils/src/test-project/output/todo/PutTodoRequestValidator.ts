...
export class PutTodoRequestValidator extends RequestValidator {
  public safeValidate(
    request: IHttpRequest,
  ): SafeRequestValidationResult<IPutTodoRequest> {
    ...
    return {
      isValid: true,
      data: validatedRequest as IPutTodoRequest,
    };
  }

  public validate(request: IHttpRequest): IPutTodoRequest {
