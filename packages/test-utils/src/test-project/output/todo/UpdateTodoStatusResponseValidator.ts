...
import {
  ...
  type IUpdateTodoStatusSuccessResponseBody,
  type IUpdateTodoStatusSuccessResponseHeader,
...
import {
  ...
  type ITodoStatusTransitionInvalidErrorResponseBody,
  type ITodoStatusTransitionInvalidErrorResponseHeader,
...
export class UpdateTodoStatusResponseValidator extends ResponseValidator {
  ...
  private validateUpdateTodoStatusSuccessResponse(
    ...
    const validateBodyResult = definition.responses[0].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<IUpdateTodoStatusSuccessResponseBody>;
    ...
    const validateHeaderResult = definition.responses[0].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<IUpdateTodoStatusSuccessResponseHeader>;
    ...
    return {
      ...
      data: new UpdateTodoStatusSuccessResponse(
        validatedResponse as IUpdateTodoStatusSuccessResponse,
      ),
    };
  }
  ...
  private validateTodoStatusTransitionInvalidErrorResponse(
    ...
    const validateBodyResult = definition.responses[2].body.safeParse(
      response.body,
    ) as unknown as ZodSafeParseResult<ITodoStatusTransitionInvalidErrorResponseBody>;
    ...
    const validateHeaderResult = definition.responses[2].header.safeParse(
      coercedHeader,
    ) as unknown as ZodSafeParseResult<ITodoStatusTransitionInvalidErrorResponseHeader>;
    ...
    return {
      ...
      data: new TodoStatusTransitionInvalidErrorResponse(
        validatedResponse as ITodoStatusTransitionInvalidErrorResponse,
      ),
    };
  }
