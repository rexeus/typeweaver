...
export class UpdateTodoStatusResponseValidator extends ResponseValidator {
  public safeValidate(
    ...
    let data: UpdateTodoStatusResponse;
    switch (response.statusCode) {
      case 200: {
        if (validationResult.validResponseName === "UpdateTodoStatusSuccess") {
          data = new UpdateTodoStatusSuccessResponse(
            validationResult.validatedResponse as unknown as IUpdateTodoStatusSuccessResponse,
          );
          break;
        }
      ...
      case 409: {
        if (
          ...
          data = new TodoStatusTransitionInvalidErrorResponse(
            validationResult.validatedResponse as unknown as ITodoStatusTransitionInvalidErrorResponse,
          );
          break;
        }

        if (validationResult.validResponseName === "TodoNotChangeableError") {
          data = new TodoNotChangeableErrorResponse(
            validationResult.validatedResponse as unknown as ITodoNotChangeableErrorResponse,
          );
          break;
        }
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const isUpdateTodoStatusSuccessResponse =
        this.validateUpdateTodoStatusSuccessResponse(
          response,
          validatedResponse,
          error,
        );
      if (isUpdateTodoStatusSuccessResponse) {
        return {
          validResponseName: "UpdateTodoStatusSuccess",
          validatedResponse,
        };
      }
    }
    ...
    if (response.statusCode === 409) {
      const isTodoStatusTransitionInvalidErrorResponse =
        this.validateTodoStatusTransitionInvalidErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isTodoStatusTransitionInvalidErrorResponse) {
        return {
          validResponseName: "TodoStatusTransitionInvalidError",
          validatedResponse,
        };
      }

      const isTodoNotChangeableErrorResponse =
        this.validateTodoNotChangeableErrorResponse(
          response,
          validatedResponse,
          error,
        );
      if (isTodoNotChangeableErrorResponse) {
        return {
          validResponseName: "TodoNotChangeableError",
          validatedResponse,
        };
      }
    }
  ...
  private validateUpdateTodoStatusSuccessResponse(
    ...
    assert(
      ...
      "'UpdateTodoStatusSuccessResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'UpdateTodoStatusSuccessResponseHeader' has to be defined in the definition",
    );
  ...
  private validateTodoStatusTransitionInvalidErrorResponse(
    ...
    assert(
      ...
      "'TodoStatusTransitionInvalidErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'TodoStatusTransitionInvalidErrorResponseHeader' has to be defined in the definition",
    );
  ...
  private validateTodoNotChangeableErrorResponse(
    ...
    assert(
      ...
      "'TodoNotChangeableErrorResponseBody' has to be defined in the definition",
    );
    ...
    assert(
      ...
      "'TodoNotChangeableErrorResponseHeader' has to be defined in the definition",
    );
