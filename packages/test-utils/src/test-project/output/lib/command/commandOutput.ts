...
import type { GeneratedCommand, GeneratedCommandIo, GeneratedCommandProgram } from "./types.js";

export const helpText = (program: GeneratedCommandProgram, command?: GeneratedCommand): string => {
