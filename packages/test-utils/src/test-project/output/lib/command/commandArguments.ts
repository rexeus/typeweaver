...
export const onlyValue = (parsed: ParsedArguments, option: string): string | undefined => {
...
export const validateKnownOptions = (command: GeneratedCommand, parsed: ParsedArguments): void => {
