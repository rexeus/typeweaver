...
export abstract class Validator {
   ...
   */
  protected analyzeSchema(shape: $ZodShape, caseSensitive: boolean): Map<string, SchemaInfo> {
   ...
   * @returns
   */
  protected getSchema(headerSchema: HttpHeaderSchema | HttpQuerySchema): $ZodShape {
   ...
   */
  private buildSchemaMap(shape: $ZodShape, caseSensitive: boolean): Map<string, SchemaInfo> {
   ...
   */
  protected coerceToSchema(data: unknown, shape: $ZodShape, caseSensitive: boolean): unknown {
   ...
   */
  private coerceValueStructure(value: unknown, expectsArray: boolean): unknown | unknown[] {
   ...
   */
  private splitCommaDelimitedValues(header: object, shape: $ZodShape): Record<string, unknown> {
