 ...
 */
function coerceRecordToSchema(data, keyType, valueType, splitCommaDelimited) {
  if (typeof data !== "object" || data === null || Array.isArray(data)) {
    return data;
  }
 ...
 */
function splitCommaDelimitedValues(header, shape) {
 ...
 */
function addValueToCoerced(coerced, key, value, expectsArray) {
 ...
 */
function mapToOriginalKeys(coerced, schemaMap) {
