...
function followingStaticDelimiter(path: string, placeholderEnd: number): string | undefined {
...
function encodePathParameter(
  ...
  if (serialized === "." || serialized === "..") {
    throw new PathParameterError(`Path parameter '${key}' cannot be a URL dot-segment`, key, path);
  }
