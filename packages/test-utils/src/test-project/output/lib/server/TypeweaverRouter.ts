 ...
 */
export type TypeweaverRouterOptions<RequestHandlers extends Record<string, RequestHandler>> = {
  /**
 ...
 */
export abstract class TypeweaverRouter<RequestHandlers extends Record<string, RequestHandler>> {
