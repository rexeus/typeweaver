...
export class GetMetricKeyedLabelsRequestValidator extends RequestValidator<IGetMetricKeyedLabelsRequest> {
  public safeValidate(
    request: IRawHttpRequest,
  ): SafeRequestValidationResult<IGetMetricKeyedLabelsRequest> {
    ...
    const headerResult = this.safeParseAs<IGetMetricKeyedLabelsRequestHeader>(
      headerSchema,
      coercedHeader,
    );
    ...
    const paramResult = this.safeParseAs<IGetMetricKeyedLabelsRequestParam>(
      paramSchema,
      request.param,
    );
    ...
    const queryResult = this.safeParseAs<IGetMetricKeyedLabelsRequestQuery>(
      querySchema,
      coercedQuery,
    );
  ...
  public validate(request: IRawHttpRequest): IGetMetricKeyedLabelsRequest {
