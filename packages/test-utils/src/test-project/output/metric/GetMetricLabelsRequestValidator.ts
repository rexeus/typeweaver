...
export class GetMetricLabelsRequestValidator extends RequestValidator<IGetMetricLabelsRequest> {
  public safeValidate(
    request: IRawHttpRequest,
  ): SafeRequestValidationResult<IGetMetricLabelsRequest> {
    ...
    const paramResult = this.safeParseAs<IGetMetricLabelsRequestParam>(paramSchema, request.param);
  ...
  public validate(request: IRawHttpRequest): IGetMetricLabelsRequest {
