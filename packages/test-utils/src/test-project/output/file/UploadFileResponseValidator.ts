...
export class UploadFileResponseValidator extends ResponseValidator {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 201) {
      const validateUploadFileSuccessResponseResult =
        this.validateUploadFileSuccessResponse(response, error);
  ...
  private validateUploadFileSuccessResponse(
    ...
    return {
      isValid: true,
      data: new UploadFileSuccessResponse(
        result.data as IUploadFileSuccessResponse,
      ),
    };
  }
