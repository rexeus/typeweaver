...
import {
  ...
  type IUploadFileSuccessResponse,
...
export class UploadFileResponseValidator extends ResponseValidator {
  ...
  private validateUploadFileSuccessResponse(
  ...
  ): SafeResponseValidationResult<UploadFileSuccessResponse> {
    const result = this.validateResponseType<UploadFileSuccessResponse>(
      "UploadFileSuccess",
    ...
    return {
      isValid: true,
      data: new UploadFileSuccessResponse(result.data as IUploadFileSuccessResponse),
    };
  }
