...
export class GetFileMetadataResponseValidator extends ResponseValidator {
  ...
  private validateGetFileMetadataSuccessResponse(
  ...
  ): SafeResponseValidationResult<IGetFileMetadataSuccessResponse> {
    const result = this.validateResponseType<IGetFileMetadataSuccessResponse>(
    ...
    return {
      isValid: true,
      data: {
        _tag: "GetFileMetadataSuccess" as const,
        statusCode: result.data.statusCode,
        header: result.data.header,
        body: result.data.body,
      } as IGetFileMetadataSuccessResponse,
    };
  }
