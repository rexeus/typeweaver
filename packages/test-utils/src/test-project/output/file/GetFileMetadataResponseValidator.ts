...
import {
  ...
  type IGetFileMetadataSuccessResponse,
  GetFileMetadataSuccessResponse,
} from "./GetFileMetadataResponse";
...
export class GetFileMetadataResponseValidator extends ResponseValidator {
  public safeValidate(
    response: IHttpResponse,
  ): SafeResponseValidationResult<GetFileMetadataResponse> {
  ...
  public validate(response: IHttpResponse): GetFileMetadataResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateGetFileMetadataSuccessResponseResult =
        this.validateGetFileMetadataSuccessResponse(response, error);
      if (validateGetFileMetadataSuccessResponseResult.isValid) {
        return validateGetFileMetadataSuccessResponseResult;
      }
    }
  ...
  private validateGetFileMetadataSuccessResponse(
    response: IHttpResponse,
    error: ResponseValidationError,
  ): SafeResponseValidationResult<GetFileMetadataSuccessResponse> {
    const result = this.validateResponseType<GetFileMetadataSuccessResponse>(
    ...
    return {
      isValid: true,
      data: new GetFileMetadataSuccessResponse(result.data as IGetFileMetadataSuccessResponse),
    };
  }
