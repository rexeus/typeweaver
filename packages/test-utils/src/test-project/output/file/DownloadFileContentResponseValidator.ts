...
export class DownloadFileContentResponseValidator extends ResponseValidator {
  ...
  ): SafeResponseValidationResult<DownloadFileContentResponse> {
  ...
  public validate(response: IHttpResponse): DownloadFileContentResponse {
  ...
  private validateAgainstDefinedResponses(
    ...
    if (response.statusCode === 200) {
      const validateDownloadFileContentSuccessResponseResult =
        this.validateDownloadFileContentSuccessResponse(response, error);
      if (validateDownloadFileContentSuccessResponseResult.isValid) {
        return validateDownloadFileContentSuccessResponseResult;
      }
    }
  ...
  private validateDownloadFileContentSuccessResponse(
    ...
    return this.validateResponseType<IDownloadFileContentSuccessResponse>(
