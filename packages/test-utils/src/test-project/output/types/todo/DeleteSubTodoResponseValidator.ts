...
const deleteSubTodoSuccessDefinition = getResponseDefinition(
...
export class DeleteSubTodoResponseValidator extends ResponseValidator<DeleteSubTodoResponse> {
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      ...
      statusCode: 200,
      headerSchema: deleteSubTodoSuccessDefinition.header,
      bodySchema: deleteSubTodoSuccessDefinition.body,
    },
