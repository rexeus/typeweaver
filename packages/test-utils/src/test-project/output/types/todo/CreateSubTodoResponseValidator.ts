...
const createSubTodoSuccessDefinition = getResponseDefinition(
  ...
  protected override readonly responseEntries: readonly ResponseEntry[] = [
    {
      ...
      statusCode: 201,
      headerSchema: createSubTodoSuccessDefinition.header,
      bodySchema: createSubTodoSuccessDefinition.body,
    },
