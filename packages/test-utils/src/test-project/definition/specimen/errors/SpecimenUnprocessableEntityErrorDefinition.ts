...
export default new HttpResponseDefinition({
  ...
  body: z.object({
    ...
    validationErrors: z.array(z.object({
      ...
      reason: z.enum(["invalid_format", "required", "too_long", "too_short", "out_of_range"]),
  ...
  description: "Specimen unprocessable entity error with comprehensive validation details",
});
