...
> against `typeweaver-effect-4.md` and the pinned Effect 4.0.0-rc.116 source. Any "use", "default", or
> "preferred" wording below is superseded by the active repository contract in `../SKILL.md`.
